...
const getUserInformationFromFid = async (fid) => {
  try {
    const response = await axios.get(
      `https://api.neynar.com/v1/farcaster/user?fid=${fid}&viewerFid=18350`,
      {
        headers: {
...
module.exports = { getCastFromNeynar, getAddrByFid, getUserInformationFromFid };
